...
if CLIENT then
    SWEP.PrintName = "Random Play Van"
    SWEP.Slot = 7
    SWEP.ViewModelFlip = false
    SWEP.ViewModelFOV = 54
    SWEP.Icon = "vgui/ttt/icon_detective_playvan.png"

    SWEP.EquipMenuData = {
        type = "Weapon",
        desc = "Drive around in your very own Random Play van!\n\nTakes damage from being shot."
    }
end
...
local carModel = "models/zzz/veh/playvan/playvan.mdl"
SWEP.ViewModel = ""
...
sound.Add({
	name="Wise.RandomPlay",
	channel=CHAN_AUTO,
	volume=1,
	level=140,
	pitch=100,
	sound="weapons/randomplay/randomplay.wav"
})

-- Spawns car where the player is looking
function SWEP:PrimaryAttack()
	self:EmitSound("Wise.RandomPlay")
    ...
    hook.Add("PlayerButtonUp", "simfphys_fixnumpads", function(ply, btn)
        numpad.Deactivate(ply, btn)
    end)

    hook.Add("PlayerButtonDown", "simfphys_fixnumpads", function(ply, btn)
